...
namespace seal
{
    vector<SmallModulus> CoeffModulus::BFVDefault(size_t poly_modulus_degree, sec_level_type sec_level)
    {
    ...
    vector<SmallModulus> CoeffModulus::Create(size_t poly_modulus_degree, vector<int> bit_sizes)
    {

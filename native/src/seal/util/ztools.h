...
namespace seal
{
    namespace ztools
    {
        ...
        int z_deflate_stream(std::istream &in_stream, std::ostream &out_stream)
        {
            int result, flush;
            ...
            do
            {
                if (!in_stream.read(reinterpret_cast<char*>(in), buf_size) && 
                    !in_stream.eof())
                {
                    deflateEnd(&zstream);
                    return Z_ERRNO;
        ...
        int z_inflate_stream(std::istream &in_stream, std::ostream &out_stream)
        {
            int result;
            unsigned have;

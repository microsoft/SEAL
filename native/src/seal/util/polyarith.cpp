...
namespace seal
{
    namespace util
    {
            ...
            size_t result_coeff_count, size_t result_coeff_uint64_count, uint64_t *result, MemoryPool &pool)
        {
            ...
            operand1_coeff_count =
                get_significant_coeff_count_poly(operand1, operand1_coeff_count, operand1_coeff_uint64_count);
            operand2_coeff_count =
                get_significant_coeff_count_poly(operand2, operand2_coeff_count, operand2_coeff_uint64_count);
        ...
        void poly_eval_poly(
            const uint64_t *poly_to_eval, size_t poly_to_eval_coeff_count, size_t poly_to_eval_coeff_uint64_count,
            const uint64_t *value, size_t value_coeff_count, size_t value_coeff_uint64_count, size_t result_coeff_count,
        ...
        void exponentiate_poly(
            const std::uint64_t *poly, size_t poly_coeff_count, size_t poly_coeff_uint64_count,
            ...
            size_t result_coeff_uint64_count, std::uint64_t *result, MemoryPool &pool)
        {
            ...
            auto big_alloc(allocate_uint(
                mul_safe(
                    add_safe(result_coeff_count, result_coeff_count, result_coeff_count), result_coeff_uint64_count),
                pool));
